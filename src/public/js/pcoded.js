...
$(document).ready(function() {
    ...
    function s(e) {
        $(".header-chat .main-friend-chat").append('' + $(".h-send-chat").val() + 'now'), d($(".h-send-chat").val()), i(), $(".h-send-chat").val(null)
    }

    function d(e) {
        setTimeout(function() {
            $(".header-chat .main-friend-chat").append('Generic placeholder imageTyping . . .now'), i()
        }, 1500), setTimeout(function() {
            document.getElementsByClassName("rem-msg")[0].innerHTML = "hello superior personality you write" + e + "", $(".rem-msg").removeClass("rem-msg"), $(".typing").removeClass("typing"), i()
        }, 3e3)
    }
    ...
    $(".card-option .close-card").on("click", function() {
        ...
        var e = $(this);
        e.parents(".card").addClass("card-load"), e.parents(".card").append(''), setTimeout(function() {
